	...
	<div class="modal fade" id="myModal-bio" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title text-center" id="myModalLabel">LEISA PETERSON</h4>
	      </div>
	      <div class="modal-body">
				...
				<section id="popup-form-click" class="clearfix">
					...
					<article class="popup-text col-sm-6 col-md-6 col-lg-6">
											
						<h5>
						    Leisa Peterson helps successful but overworked entrepreneurs slow down and enjoy life WAY more so they can create even 
						    more profitable businesses that fulfills their wildest dreams.  She’s an intuitive business coach, money and mindfulness 
						    expert and bestselling author on Amazon.

						    <br><br>

							Leisa’s known for her ability to quickly identify the exact issues that are holding someone back from achieving the goals 
							they desire.  Once discovered Leisa draws upon various modalities including energy clearing, shadow work, Emotional Freedom 
							Technique, Allowing ™, mindfulness practices and breath work to assist her clients in clearing out these emotional and mental 
							obstacles.  Once cleared Leisa gives customized instructions for how to apply the breakthrough experiences to enhance every 
							aspect of their lives: financial, business and personal.
						    <br><br>

							As a result of her teachings, Leisa is helping thousands of people develop practical skills for attracting greater wealth, 
							freedom and peace of mind into their lives.  She’s also the founder of wealthclinic.com where she hosts a podcast and blogs 
							about what it means to manage money mindfully.  Leisa is a CERTIFIED FINANCIAL PLANNER ™ and has an MBA in finance.  She worked 
							in personal finance for over 20 years and has been an entrepreneur since she started selling gardening seeds door-to-door at age 8.
						    <br><br>
