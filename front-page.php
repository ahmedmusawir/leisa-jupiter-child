 ...
 <figure class="video-container">
    ...
    <!-- <h3>Featured Poems</h3> -->
	    ...
	    <div class="text-content text-center featured-poem-1">
			...
			that keep you from getting<br>
			the results you want<br>
			including more clients,<br>
			more money,<br>
			more time<br>
			and greater confidence.</p>
	...
	<div class="container-fluid">
		...
		<div class="col-sm-6 col-md-6 col-lg-6 content-block">
			...
			<article class="text-block text-left">
				...
				<h5>Do you want to feel an ever-increasing sense of fulfillment, clarity and joy?</h5>

				<h5>
					If you’re like many of my clients, you are ready to create a more fulfilling and satisfying life than you’ve ever experienced.  You know life is meant to be enjoyed and you are tired of being burned out.  You want to get better at what you do, you want to remove the blocks in your path and you want to reach your fullest potential.
				</h5>
				<h5>
					But instead you find yourself in that mode of there being never being enough time, energy nor clarity to accomplish what you want.
				</h5>
		...
		<div class="col-sm-6 col-md-6 col-lg-6 content-block">
			...
			<article class="text-block text-right">
				...
				<h5>Like you can’t get where you want to go no matter how hard you try</h5>

				<h5>Important things are falling through the cracks, including your family?</h5>

				<h5>You have very little to show for all the time you are putting into your business?</h5>

				<h5>Worry, stress and regret about where you are when it comes to building wealth?</h5>

				<h5>You need a mentor who can guide you along your path to success?</h5>			
